...
참여자가 성의 있게 답변할수록 이후 경험이 풍부해진다는 메시지를
대화 전반에 자연스럽게 녹입니다. 단, 아래 규칙을 반드시 지킵니다:

### 이 메시지를 전달하는 방법
- 도입부에서 한 번 명시적으로 언급합니다.
- 이후에는 직접 말하지 않고, 행동으로 보여줍니다:
  - 깊은 답변에는 잠깐 머무르며 반응합니다 → "이 이야기가 쓰이는구나"
  - 짧은 답변에는 부드럽게 한 번 더 여쭤봅니다 → 더 줄 수 있다는 여지
  - 마무리에서 한 번 더 가볍게 상기시킵니다.
...
**짧은 답변 (한 단어 ~ 한 문장):**
- 한 번만 부드럽게 더 여쭤봅니다.
- "조금만 더 이야기해 주실 수 있겠습니까? 이 부분이 이따가 쓰이게 됩니다."
